...
in
{
  ...
  "ssh-config_yzx9-mbp.age".publicKeys = admins ++ [ system_yzx9-mbp ];

  # yzx9-ws only
  "frpc_yzx9-ws.toml.age".publicKeys = admins ++ [ user_yzx9-ws ] ++ [ system_yzx9-ws ];
  "xray_yzx9-ws.json.age".publicKeys = admins ++ [ user_yzx9-ws ] ++ [ system_yzx9-ws ];
}
