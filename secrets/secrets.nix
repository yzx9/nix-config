...
{
  # yzx9-mbp only
  "id-git_yzx9-mbp.age".publicKeys = [ user_yzx9-mbp ] ++ [ system_yzx9-mbp ];
  "id-github_yzx9-mbp.age".publicKeys = [ user_yzx9-mbp ] ++ [ system_yzx9-mbp ];
  "ssh-config_yzx9-mbp.age".publicKeys = [ user_yzx9-mbp ] ++ [ system_yzx9-mbp ];
